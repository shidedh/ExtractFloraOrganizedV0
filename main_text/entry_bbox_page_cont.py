...
genus_parts = volume_word_df[(volume_word_df['word'].isin(volume_genera))] #or technically doing a close match etc 
...
# %%
print("\n".join(volume_word_df[(volume_word_df['page_num'] == 174) & (volume_word_df['section_id'] == (174, 1, 0)) & (volume_word_df['word_num'] == 0)]['word']))
