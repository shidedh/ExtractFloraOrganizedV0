...
# ------------------------ IMPORT VOLUMES ------------------------ #
vol2last8_path = "../../../Downloads/Vol2_last8.pdf"
vol2last8_doc = fitz.open(vol2last8_path)

vol2last8_pages = [vol2last8_doc[i] for i in range(vol2last8_doc.page_count)]
# ---------------------------------------------------------------- #
...
# ----------------------- Extract And Save ----------------------- #
print("\nextracting volume 2 _ last 8 pages")
vol2last8_df = book_char_df("2", vol2last8_pages)
process_words_in_place(vol2last8_df)
vol2last8_df = rearrange_cols(vol2last8_df)

print("Saving volume  - last 8")
vol2last8_df.to_pickle("../input/char_df/vol2last8_df.pkl")
vol2last8_df.to_csv("../../../Downloads/Vol2_last8.csv", index = False)
# ---------------------------------------------------------------- #
...
all_vol_data_col_num = [(vol1_char_df, vol1_index, vol1_doc),
                        (vol2_last8__char_df, vol2_last8__index, vol2_last8__doc),
...
# %%
for vol_char_df ,vol_index, doc in all_vol_data_col_num: 
    vol_char_df['line_y'] = vol_char_df['line_bbox'].apply(lambda x : x[1])

# %%
for vol_char_df ,vol_index, doc in all_vol_data_col_num: 
    vol_char_df.sort_values(by = ['page_num', 'col_num', 'line_y'], inplace = True)
...
all_vol_data_flagg_strict_match = [(vol1_char_df, vol1_index, vol1_doc, "strickt_match_vol1"),
                                   (vol2_last8__char_df, vol2_last8__index, vol2_last8__doc, "strickt_match_vol2_last8_"),
...
all_vol_data_epithet_coord_match_test = [(vol1_char_df, vol1_index, vol1_doc, "epithet_coord_match_pruned_vol1"),
                                         (vol2_last8__char_df, vol2_last8__index, vol2_last8__doc, "epithet_coord_match_pruned_vol2_last8_"),
...
all_vol_data_genus_coord_match_test = [(vol1_char_df, vol1_index, vol1_doc, "genus_coord_match_vol1"),
                                       (vol2_last8__char_df, vol2_last8__index, vol2_last8__doc, "genus_coord_match_vol2_last8_"),
...
vol2_last8__char_df['potential_genus_match'] = vol2_last8__char_df.apply(potential_genus_match, axis = 1)
vol2_last8__char_df['potential_epithet_match'] = vol2_last8__char_df.apply(potential_epithet_match, axis = 1)
...
all_vol_data_GE_potential_match_test = [(vol1_char_df, vol1_index, vol1_doc, "GE_potential_match_vol1"),
                                        (vol2_last8__char_df, vol2_last8__index, vol2_last8__doc, "GE_potential_match_vol2_last8_"),
...
vol2_last8__char_df['index_page_num'] = vol2_last8__char_df['page_num'] - vol2_last8__index[0] + 1
...
all_vol_data_PN_test = [(vol1_char_df, vol1_index, vol1_doc, "potential_page_num_match_vol1"),
                        (vol2_last8__char_df, vol2_last8__index, vol2_last8__doc, "potential_page_num_match_vol2_last8_"),
...
# %%
vol2_last8__char_df[(vol2_last8__char_df['potential_infra_match'] == True) & (vol2_last8__char_df['word'].apply(has_infra_symbols) == False)][["index_page_num", "word"]].drop_duplicates()
...
# %%
vol2_last8__char_df[(vol2_last8__char_df['potential_epithet_match'] == True) & (vol2_last8__char_df['word'].apply(potential_author_match_epithet_coord))][["index_page_num", "word"]].drop_duplicates()
...
# %%
vol2_last8__char_df[(vol2_last8__char_df['potential_epithet_match'] == True) & (vol2_last8__char_df['word'].apply(has_upper_not_first))][["index_page_num", "word"]].drop_duplicates()
...
# %%
vol2_last8__char_df[(vol2_last8__char_df['potential_genus_match'] == True) & (vol2_last8__char_df['word'].apply(flag_genus_name))][["index_page_num", "word"]].drop_duplicates()

# %%
# not_genus_index_list_vol2_last8_ = [1939606]
# for i in not_genus_index_list_vol2_last8_:
#     vol2_last8__char_df.loc[i : get_index_end(vol2_last8__char_df, i),'potential_genus_match'] = False
...
vol2_last8__char_df[(vol2_last8__char_df['potential_genus_match'] == True) & (vol2_last8__char_df['word'].apply(lambda x : x[0].isupper() == False))]['word']
...
vol1_index_df, vol2_last8__index_df, vol3_index_df = result[0], result[1], result[2]

# %%
all_vol_data_PN_test = [(vol1_index_df, vol1_index, vol1_doc, "valid_words_vol1"),
                        (vol2_last8__index_df, vol2_last8__index, vol2_last8__doc, "valid_words_vol2_last8_"),
...
vol_index_df_list = [vol1_index_df, vol2_last8__index_df, vol3_index_df]
result_df = []
...
vol1_index_df, vol2_last8__index_df, vol3_index_df = result_df[0], result_df[1], result_df[2]
...
# %%
result_df_hybrids = []
for vol_index_df in [vol1_index_df, vol2_last8__index_df, vol3_index_df]:
...
vol1_index_df, vol2_last8__index_df, vol3_index_df = result_df_hybrids[0], result_df_hybrids[1], result_df_hybrids[2]
...
vol1_index_df, vol2_last8__index_df, vol3_index_df = result_df_authors[0], result_df_authors[1], result_df_authors[2]
...
all_vol_data_cat_test = [(vol1_index_df, vol1_index, vol1_doc, "catagorized_vol1"),
                         (vol2_last8__index_df, vol2_last8__index, vol2_last8__doc, "catagorized_vol2_last8_"),
...
prune_authors_vol1, prune_authors_vol2_last8_, prune_authors_vol3 =  result_prune_authors_list[0], result_prune_authors_list[1], result_prune_authors_list[2]
...
prune_authors_vol2_last8_['closest_genus'] = prune_authors_vol2_last8_['closest_genus'].str.replace("œ", "oe" )
...
prune_authors_vol2_last8_['closest_epithet'] = prune_authors_vol2_last8_['closest_epithet'].str.replace("œ", "oe" )
...
prune_authors_vol2_last8_['closest_infra_name'] = prune_authors_vol2_last8_['closest_infra_name'].str.replace("œ", "oe" )
prune_authors_vol3['closest_infra_name'] = prune_authors_vol3['closest_infra_name'].str.replace("œ", "oe" )

# %%
for vol_index_df in [prune_authors_vol1, prune_authors_vol2_last8_, prune_authors_vol3]:
...
simplified_vol2_last8_ = prune_authors_vol2_last8_[['closest_genus',
                                      'closest_epithet',
                                      'closest_infra_name',
                                      'authors',
                                      'taxon_rank',
                                      'taxon_rank_detailed']]
simplified_vol2_last8_.to_csv('../output/local/index_output/vol2_last8__index_output.csv')
...
non_italics_simplified_vol2_last8_ = prune_authors_vol2_last8_.loc[(prune_authors_vol2_last8_['span_flags'] != 6),
                                                     ['closest_genus',
                                                      'closest_epithet',
                                                      'closest_infra_name',
                                                      'authors',
                                                      'taxon_rank',
                                                      'taxon_rank_detailed']]
non_italics_simplified_vol2_last8_.to_csv('../output/local/index_output/vol2_last8__nonitalics.csv')
